    ...
    def get_six_relationships_summary() -> Dict[str, Any]:
        try:
            ...
            with neo4j.driver.session() as session:
                ...
                if record:
                    relationship_counts['CO_AUTHORED_WITH'] = record['count']
                ...
                record = result.single()
                if record:
                    relationship_counts['SUPERVISED'] = record['count']
                ...
                record = result.single()
                if record:
                    relationship_counts['TEAMWORK_WITH'] = record['count']
                ...
                record = result.single()
                if record:
                    relationship_counts['PARTICIPATED_IN'] = record['count']
                ...
                record = result.single()
                if record:
                    relationship_counts['AUTHORED'] = record['count']
                ...
                record = result.single()
                if record:
                    relationship_counts['PRODUCED'] = record['count']
